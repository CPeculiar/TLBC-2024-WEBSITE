              ...
              <div className="flex flex-col gap-6">
                ...
                <div>
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 border rounded-md ${
                      formErrors.church ? "border-red-500" : "border-gray-300"
                    }`}
                    placeholder="Church"
                  />
                  {formErrors.church && (
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full px-6 py-2.5 bg-yellow-600 text-white rounded-md hover:bg-yellow-700 transition duration-300"
                  >
                    Send message
                  </button>
                </div>
